    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-border bg-surface/50 backdrop-blur-sm mb-8 animate-fade-in">
      ...
      <section id="services" className="relative py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="font-sora font-bold text-3xl md:text-4xl text-text-primary">
              Services &amp; Expertise
            </h2>
          </div>
      ...
      {/* ══════ Portfolio Section ══════ */}
      <section id="portfolio" className="relative py-24 px-6 border-t border-border/50">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {portfolioItems.map((item, i) => (
              <div key={item.title} className="relative group">
                {item.locked ? (
                  /* ── Locked Card ── */
                  <div className="glass-card p-8 h-64 flex flex-col items-center justify-center text-center relative overflow-hidden">
                    {/* Blurred placeholder content */}
                    <div className="absolute inset-0 p-6 blur-sm opacity-30">
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-3">
                      <div className="w-12 h-12 rounded-full bg-border/50 flex items-center justify-center text-text-muted">
                        <LockIcon />
                      </div>
                      <p className="font-sora font-semibold text-text-primary">{item.title}</p>
                  ...
                  <Link href="/dashboard" className="block">
                    <div className="glass-card p-8 h-64 flex flex-col items-center justify-center text-center border-primary/30 hover:border-primary/60 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-primary/10">
                      {/* Preview content */}
                      <div className="w-14 h-14 rounded-xl bg-primary/15 flex items-center justify-center mb-4 group-hover:bg-primary/25 transition">
                        <svg className="w-7 h-7 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
                        </svg>
                      </div>
                      <p className="font-sora font-semibold text-text-primary mb-1">{item.title}</p>
      ...
      {/* ══════ Contact Section ══════ */}
      <section id="contact" className="relative py-24 px-6 border-t border-border/50">
        <div className="max-w-2xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-12">
            <p className="text-accent font-medium text-sm uppercase tracking-widest mb-3">Get In Touch</p>
            <h2 className="font-sora font-bold text-3xl md:text-4xl text-text-primary mb-4">
              Let&apos;s Work Together
            </h2>
      ...
      <footer className="border-t border-border/50 py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-sora font-bold gradient-text">LancerLink</p>
